...
const Notas = () => {
    return (
      <section class="bg-preto text-white">
  <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    <div class="mx-auto max-w-lg text-center">
      <h2 class="text-3xl font-bold sm:text-4xl">Veja o que nossos clientes dizem:</h2>
    ...
    <div class="mt-8 grid grid-cols-2 gap-8 md:grid-cols-2 lg:grid-cols-3">
      <div
      ...
      >
        ...
        <h2 class="mt-2 text-xl font-bold text-white ml-2 mb-5">Cliente X</h2></div>
